...
class TestVector(unittest.TestCase):
    ...
    def test_are_parrallel(self):
        self.assertTrue(self.u.is_prarallel_to(self.u))

    def test_are_not_parrallel(self):
        self.assertFalse(self.u.is_prarallel_to(self.v))
...
#python3 -m unittest <python file>
